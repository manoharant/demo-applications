package com.lhcargo.microservices.services;

import com.lhcargo.microservices.accounts.AccountsServer;
import com.lhcargo.microservices.customers.CustomerServer;
import com.lhcargo.microservices.services.registration.RegistrationServer;
import com.lhcargo.microservices.services.web.WebServer;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (serverName.equals("registration") || serverName.equals("reg")) {
			...
			WebServer.main(args);
		} else if (serverName.equals("customers")) {
	...
	protected static void usage() {
		...
		System.out.println("     where server-name is 'reg', 'registration', "
				+ "'accounts' or 'web' or 'customers' and server-port > 1024");
	}
}
